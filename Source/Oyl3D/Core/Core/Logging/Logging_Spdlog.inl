...
namespace Oyl::Logging
{
	...
	FromSourceInfo(const Detail::SourceInfo& a_info)
	{
	...
	void
	Debug(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
	...
	template<typename T>
	void
	Debug(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T, typename... TArgs>
	void
	Info(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T>
	void
	Info(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T, typename... TArgs>
	void
	Log(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
	...
	template<typename T>
	void
	Log(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
	...
	template<typename T, typename... TArgs>
	void
	Warning(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T>
	void
	Warning(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T, typename... TArgs>
	void
	Error(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T>
	void
	Error(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T, typename... TArgs>
	void
	Fatal(const Detail::SourceInfo a_sourceInfo, const T& a_fmt, TArgs&&... a_args)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
	...
	template<typename T>
	void
	Fatal(const Detail::SourceInfo a_sourceInfo, const T& a_fmt)
	{
		_OYL_LOGGING_PROFILE_PRE_FORMATTED();
