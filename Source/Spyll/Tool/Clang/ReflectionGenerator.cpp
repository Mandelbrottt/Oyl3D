...
#include "Tool/Core/EnumDescriptor.h"
#include "Tool/Core/FieldDescriptor.h"
#include "Tool/Core/FunctionDescriptor.h"
#include "Tool/Core/TypeDescriptor.h"
#include "Tool/Core/VariableDescriptor.h"
