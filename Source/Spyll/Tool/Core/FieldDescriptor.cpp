...
namespace Spyll
{
	...
	void
	to_json(json& a_json, const FieldDescriptor& a_descriptor)
	{
		a_json = json {};
		...
		OBJ_MEMBER_AS_JSON(a_json, a_descriptor, offsetInBits);
	...
	void
	from_json(const json& a_json, FieldDescriptor& a_descriptor)
	{
		...
		OBJ_MEMBER_FROM_JSON(a_json, a_descriptor, offsetInBits);
